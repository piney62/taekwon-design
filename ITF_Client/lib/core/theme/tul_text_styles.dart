...
/// Typography tokens. Names describe the role (title, body, cardHeader)
/// rather than the size so consumers don't need to know the pixel values.
///
/// The base text theme on [AppTheme] already wires Inter via google_fonts.
/// These helpers exist so new widgets can fetch a fully-specified style in
/// one call (e.g. `TulTextStyles.cardHeader(color: palette.text)`).
class TulTextStyles {
  TulTextStyles._();
