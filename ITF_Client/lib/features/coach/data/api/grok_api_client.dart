...
class GrokApiClient implements AiApiClient {
  GrokApiClient(this._client);
  ...
  Future<String> generateReply({
    ...
    if (response.statusCode == 400 || response.statusCode == 401) {
      throw const UnauthorizedException('Invalid API key. Check your Grok API key in Settings.');
    }
    ...
    if (choices == null || choices.isEmpty) {
      throw const UnknownApiException('Empty response from Grok');
    }
    ...
    if (message == null) {
      throw const UnknownApiException('No message in Grok response');
    }
